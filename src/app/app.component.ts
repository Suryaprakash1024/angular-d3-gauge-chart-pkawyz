...
export class AppComponent {
  ...
  draw() {
    ...
    var gauge = function (container :any, configuration :any) {
      ...
      var scale: { (arg0: any): any; ticks: (arg0: number) => any; } | undefined = undefined;
      var ticks = [0, 5, 7, 10];
      var tickData : number[] = [];
      ...
      function configure(configuration : any={}) {
        ...
        arc = d3.arc()
          ...
          .startAngle(function (d : any, i : number) {
            var ratio = d * i;
            return deg2rad(config.minAngle + (ratio * 240));
          })
      ...
      function render(newValue : any) {
        ...
        lg.selectAll('text')
          ...
          .attr('transform', function (d:any) {
            ...
            return 'rotate(' + newAngle + ') translate(0,' + (config.labelInset - 0.5) + ')';
          })
